...
import { CheckCircle, Eye, TimerReset, LockKeyhole } from "lucide-react";
...
export const ChapterSidebarItem = ({
  ...
  return (
    <div className="flex pt-6 pr-2 w-full">
      <div className="text-sm font-medium flex flex-col w-full">
        ...
        >
          <div className="flex justify-between items-center w-full">
            <div className="flex items-center space-x-2 w-4/5 overflow-hidden">
              ...
              {!isLocked && <Eye className="text-sky-500" size={24} />}
